...
import { PROJECT_SETTINGS } from './config.json';
import { getTokenAndContract, getPairContract, calculatePrice, getEstimatedReturn, getReserves } from './helpers/helpers';
import { uFactory, uRouter, sFactory, sRouter, web3, arbitrage } from './helpers/initialization';
...
const determineProfitability = async (_routerPath, _token0Contract, _token0, _token1) => {
    ...
    // Customize conditions to achieve as profitable a trade as possible.
    // Basic trading WETH/SHIB example below.
