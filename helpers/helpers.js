...
import { abi as _abi } from '@openzeppelin/contracts/build/contracts/ERC20.json';

async function getTokenAndContract(_token0Address, _token1Address) {
    const token0Contract = new web3.eth.Contract(_abi, _token0Address)
    const token1Contract = new web3.eth.Contract(_abi, _token1Address)
